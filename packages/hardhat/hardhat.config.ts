...
// Private key for deployment (ensure this is secure)
const deployerPrivateKey =
  process.env.__RUNTIME_DEPLOYER_PRIVATE_KEY ??
  "0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80";

// You may have other keys (Etherscan, Optimistic, Base) but here we will only rely on Sourcify.
...
const config: HardhatUserConfig = {
  ...
  // Only Sourcify will be used for verification on supported networks.
  sourcify: {
    enabled: true,
...
// Extend the deploy task to run your TypeScript ABI generator after deployments.
